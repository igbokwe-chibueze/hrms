...
export default function EmployeesPage() {
  ...
  const [employees, setEmployees] = useState<Employee[]>(getOrganizationEmployees(currentOrganization.id))
  ...
  const handleImportComplete = (result: BulkImportResult) => {
    setEmployees((prev) => [...prev, ...result.data]) // ✅ data not employees
    console.log(`✅ Imported ${result.successfulRows}/${result.totalRows} employees`)
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your organization employees and their information</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>A list of all employees in {currentOrganization.name}</CardDescription>
        </CardHeader>
        <CardContent>
